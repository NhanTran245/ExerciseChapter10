...
public class MailPage_NotFixed extends BasePage {
...
//    protected By AliasCheckBox = By.xpath("//input[@id = 'use-alias']");
...
//        driver.findElement(AliasCheckBox).click();
//
...
//        driver.findElement(emailConfirm).click(); //click email confirm
//
